...
//                            autoConnect(keyword);
    ...
    public void autoConnect(String keyword) {
        ...
        this.autoConnect(listNames);
    }

    public void autoConnect(ArrayList<String> keywordsName) {
        if (!isAutoConnectionEnabled) {
            keywordsList = keywordsName;
...
//                if(arr_name[i].contains(keywordName)) {
                for (String keyword : keywordsList) {
                    if (arr_name[i].contains(keyword)) {
